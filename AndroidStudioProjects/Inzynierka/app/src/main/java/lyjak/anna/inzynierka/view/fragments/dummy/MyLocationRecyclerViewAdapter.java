...
import lyjak.anna.inzynierka.view.fragments.dummy.LocationContent.LocationItem;

import java.util.List;

/**
 * {@link RecyclerView.Adapter} that can display a {@link LocationItem}
 *
 */
@Deprecated
public class MyLocationRecyclerViewAdapter extends RecyclerView.Adapter<MyLocationRecyclerViewAdapter.ViewHolder> {
    ...
    public MyLocationRecyclerViewAdapter(List<LocationItem> modelData) {
        mValues = modelData;
    }
